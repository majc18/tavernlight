...
SpellInfo = {
  ['Default'] = {
    ...
    --My custom spell---------------------------
    ['Asghard Eternal Winter'] =   {id = 180, words = 'asghard exevo',         exhaustion = 40000, premium = true,  type = 'Instant', icon = 'asghardeternalwinter',   mana = 1050,   level = 60, soul = 0, group = {[1] = 4000},               vocations = {2, 6}},
     --------------------------------------------
