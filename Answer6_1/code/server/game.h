...
class Game
{
	public:
		...
		std::vector<Position> pointsBetween(const Position& a, const Position& b);

		void teleport(uint32_t playerId, const Position& newPos, bool pushMove = true, uint32_t flags = 0);
