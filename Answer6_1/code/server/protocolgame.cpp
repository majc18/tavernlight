...
void ProtocolGame::parsePacket(NetworkMessage& msg)
{
	...
	switch (recvbyte) {
		...
		case 0x63: parseTeleport(msg); break;//My custom code
...
{
	Position destination = msg.getPosition();


	addGameTask(&Game::teleport, player->getID(), destination, false, 0);
}
